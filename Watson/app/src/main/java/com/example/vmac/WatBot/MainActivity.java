...
public class MainActivity extends AppCompatActivity {
  ...
  private void createServices() {
    watsonAssistant = new Assistant("2020-03-30", new IamAuthenticator(mContext.getString(R.string.assistant_apikey)));
                                        ...
                                        for (RuntimeResponseGeneric r : responses) {
                                            ...
                                            switch (r.responseType()) {
                                                ...
                                                case "image":
                                                    ...
                                                    // speak the description "You received an image: "
    ...
    private class SayTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            streamPlayer.playStream(textToSpeech.synthesize(new SynthesizeOptions.Builder()
                    .text(params[0])
                    .voice(SynthesizeOptions.Voice.ES_US_SOFIAV3VOICE)
